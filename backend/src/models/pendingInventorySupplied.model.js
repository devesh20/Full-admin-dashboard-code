...
const pendingInventorySuppliedSchema = new Schema(
  {
    typeOfRotor: {
      type: String,
...
export const PendingInventorySupplied = mongoose.model(
  'PendingInventorySupplied',
  pendingInventorySuppliedSchema
);
