...
export const materialReceivedPurchaseColumns = [
  {
  ...
  //             <Link
  //               to={`material-received/edit/${material._id}`}
  ...
  //           <DropdownMenuItem asChild>
  //             <Link
  //               to={`material-received/delete/${material._id}`}
...
export const materialReceivedSuppliedColumns = [
  {
